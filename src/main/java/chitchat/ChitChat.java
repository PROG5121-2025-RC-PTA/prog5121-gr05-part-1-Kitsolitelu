...
/**
 * Main class for the ChitChat application, a simple chat system that allows users to
 * register, log in, send messages, and view their inbox or sent messages.
 * JSON files are stored in the main project directory
 * 
 * Author: Kitso Litelu
 * Date: May 25, 2025
 */
public class ChitChat 
{
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "Welcome to ChitChat by Kitso Litelu");
        ...
        while (true) {
            ...
            int choice = JOptionPane.showOptionDialog(null, "Choose an action:", "ChitChat Menu",
